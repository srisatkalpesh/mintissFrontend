<template>
  <div class="container py-4">
    <div class="card shadow-lg border-0 mx-auto add-product-card">
      <div class="card-header text-white text-center" style="background: linear-gradient(90deg, #28a745 0%, #1177bf 100%); border-radius: 1rem 1rem 0 0;">
      ...
      <div class="card-body p-4">
        <form @submit.prevent="submitForm" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label class="form-label fw-semibold">Purchase URL</label>
          ...
          <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <router-link to="/seller/products" class="btn btn-outline-secondary ms-2" :disabled="loading">Cancel</router-link>
          </div>
        </form>
      </div>
    </div>
